...
-(void)lodatepost{
    ...
    //你的接口地址
    NSString *url=@"http://119.29.204.175:8085/schedule/register";
    [manager.requestSerializer setValue:@"toke" forHTTPHeaderField:@""];
    //发送请求
...
-(void)loadData{
    ...
    [manager GET:urlString parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
     ...
     //   NSLog(@"===oper-------=%@key==%@",operation,key);
        ...
        NSLog(@"-----dict%@,,,,,%@,%@",arrayM,dict,temArray);
